<?php echo $header; ?>
<!-- <?php var_dump($shipping_required); ?> -->
<div class="container">
  <ul class="breadcrumb">
  ...
  <div class="row"><?php echo $column_left; ?>
	...
	<div class="buttons clearfix">
        <div class="pull-right" style="margin-right:4px;"><a href="/index.php?route=extension/module/tieredgifts/listing" class="btn btn-primary">Please check your free gift.</a></div>
      </div>
